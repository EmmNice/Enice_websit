      ...
      <div className="border-b border-border bg-secondary/40 py-14 sm:py-20">
        <div className="mx-auto max-w-7xl px-5 sm:px-8">
          ...
          <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
            A complete reference for the ENICE Core REST API. Full sandbox keys and
            partner onboarding are issued upon request.
          </p>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
                      ...
                      <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-[12px]">data</code>{" "}
                      key. Errors include{" "}
                      <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-[12px]">error.code</code>{" "}
                      and{" "}
                      <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-[12px]">error.message</code>.
                    </p>
                  </div>
                </div>
              }
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
                      ...
                      <code className="rounded bg-secondary px-1.5 py-0.5 font-mono text-[12px]">Authorization</code>{" "}
                  ...
                  <div>
                    ...
                    <div className="mt-3 rounded-lg border border-border">
                      {[
                        ...
                        <div key={scope} className="flex flex-col gap-1 border-t border-border px-4 py-3 first:border-t-0 sm:flex-row sm:items-center sm:gap-6">
                          <code className="w-28 shrink-0 font-mono text-[12px] text-primary">{scope}</code>
  ...
  <span class="text-sky-300">"error"</span>: {
    ...
    <span class="text-sky-300">"message"</span>: <span class="text-amber-300">"API key missing or invalid."</span>
          ...
          <DocSection id="errors">
            <h2 className="text-2xl font-semibold tracking-tight text-foreground">Errors & Rate Limits</h2>
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              The API uses standard HTTP status codes. All error bodies follow a consistent
              shape so you can handle them uniformly.
            </p>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <div className="mt-3 rounded-lg border border-border">
                      {[
                        ...
                        <div key={code} className="flex items-center gap-4 border-t border-border px-4 py-3 first:border-t-0">
                          <code className={`w-10 shrink-0 font-mono text-[13px] font-semibold ${code.startsWith("2") ? "text-emerald-600" : code.startsWith("4") || code.startsWith("5") ? "text-red-600" : "text-foreground"}`}>{code}</code>
                          <span className="text-[13px] text-muted-foreground">{desc}</span>
                        </div>
                      ))}
                    </div>
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
                      ...
                      <strong className="font-semibold text-foreground">1,000 req/min</strong>{" "}
                      by default, burstable to 5,000. Enterprise agreements unlock higher tiers.
...
X-RateLimit-Reset:     <span class="text-violet-400">1751500860</span>`}
          ...
          <DocSection id="wallets">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              Programmable wallets support multi-currency balances, virtual card issuance,
              and peer-to-peer transfers. Each wallet is isolated per tenant.
            </p>
            ...
            <div className="mt-10">
              <div className="flex items-center gap-3">
                ...
                <code className="font-mono text-[14px] font-semibold text-foreground">/v1/wallets</code>
            ...
            <div className="mt-12 border-t border-border pt-10">
              ...
              <SplitRow
                left={
                  <div>
                    <p className="text-[14px] leading-relaxed text-muted-foreground">
                      Provisions a new wallet for an end-user or sub-account. Optionally
                      issue a virtual card at creation.
                    </p>
                    <div className="mt-6">
                      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                        Body parameters
                      ...
                      <div className="mt-3 rounded-lg border border-border">
                        <ParamRow name="currency" type="string" required desc="ISO 4217 currency code. Supported: NGN, USD." />
                        <ParamRow name="label" type="string" desc="Human-readable name for this wallet." />
                        <ParamRow name="issue_card" type="boolean" desc="If true, a virtual card is issued and linked on creation." />
                        <ParamRow name="metadata" type="object" desc="Arbitrary key-value pairs for your internal reference." />
                      </div>
                    </div>
                  </div>
                }
    ...
    <span class="text-sky-300">"user_id"</span>: <span class="text-amber-300">"usr_8823..."</span>
          ...
          <DocSection id="ledger">
            ...
            <div className="mt-10">
              <div className="flex items-center gap-3">
                <MethodBadge method="POST" />
                <code className="font-mono text-[14px] font-semibold text-foreground">/v1/ledger/tx</code>
                ...
                left={
                  <div>
                    ...
                    <div className="mt-6">
                      ...
                      <div className="mt-3 rounded-lg border border-border">
                        <ParamRow name="debit_wallet"  type="string"  required desc="Wallet ID to debit." />
                        <ParamRow name="credit_wallet" type="string"  required desc="Wallet ID to credit." />
                        <ParamRow name="amount"        type="integer" required desc="Amount in the smallest currency unit (kobo / cents)." />
                        <ParamRow name="currency"      type="string"  required desc="Must match both wallets' currency." />
                        <ParamRow name="reference"     type="string"  desc="Unique idempotency key. Duplicate references are ignored." />
                      </div>
                    </div>
                  </div>
                }
  ...
  <span class="text-sky-300">"data"</span>: {
    ...
    <span class="text-sky-300">"settled_at"</span>: <span class="text-amber-300">"2026-07-03T00:00:00Z"</span>
          ...
          <DocSection id="assist">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              The Assist API exposes PulseAssist's multi-tenant AI routing engine. Invoke
              agents, manage conversation state, and configure policy-bound automations
              via REST.
            </p>
            ...
            <div className="mt-10">
              <div className="flex items-center gap-3">
                <MethodBadge method="POST" />
                <code className="font-mono text-[14px] font-semibold text-foreground">/v1/assist/query</code>
              ...
              <SplitRow
                left={
                  <div>
                    <p className="text-[14px] leading-relaxed text-muted-foreground">
                      Routes a user message through the configured tenant agent. The agent
                      applies your policy rules, executes permitted actions, and returns a
                      structured response.
                    </p>
                    <div className="mt-6">
                      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Body parameters</p>
                      <div className="mt-3 rounded-lg border border-border">
                        <ParamRow name="session_id" type="string"  required desc="Unique conversation session identifier. Use the same ID to maintain context across turns." />
                        <ParamRow name="message"    type="string"  required desc="End-user's input message." />
                        <ParamRow name="tenant_id"  type="string"  required desc="Your PulseAssist tenant identifier." />
                        <ParamRow name="language"   type="string"  desc="BCP-47 language tag. Default: en." />
                      </div>
                    </div>
                  </div>
                }
...
<span class="text-slate-500"># 200 OK</span>
{
  <span class="text-sky-300">"data"</span>: {
    ...
    <span class="text-sky-300">"actions"</span>:    []
          ...
          {/* ── KYC ── */}
          <DocSection id="kyc">
            <h2 className="text-2xl font-semibold tracking-tight text-foreground">KYC & Identity</h2>
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              Submit identity verification requests and retrieve screening results. All KYC
              data is encrypted in transit and at rest and is never stored beyond the
              retention window.
            </p>
            ...
            <div className="mt-10">
              <div className="flex items-center gap-3">
                <MethodBadge method="POST" />
                <code className="font-mono text-[14px] font-semibold text-foreground">/v1/kyc/verify</code>
                ...
                left={
                  <div>
                    ...
                    <div className="mt-6">
                      <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Body parameters</p>
                      <div className="mt-3 rounded-lg border border-border">
                        <ParamRow name="first_name" type="string" required desc="Legal first name of the individual." />
                        <ParamRow name="last_name"  type="string" required desc="Legal last name of the individual." />
                        <ParamRow name="dob"        type="string" required desc="Date of birth in ISO 8601 format (YYYY-MM-DD)." />
                        <ParamRow name="id_type"    type="string" required desc="One of: national_id, passport, drivers_license." />
                        <ParamRow name="id_number"  type="string" required desc="Document identification number." />
                      </div>
                    </div>
                  </div>
                }
  ...
  <span class="text-sky-300">"data"</span>: {
    ...
    <span class="text-sky-300">"status"</span>:          <span class="text-amber-300">"pending"</span>
          ...
          <DocSection id="webhooks">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              The ENICE Core delivers all asynchronous events via HMAC-SHA256 signed
              webhooks with at-least-once delivery semantics and configurable retry windows.
            </p>
            ...
            <SplitRow
              left={
                <div className="space-y-6">
                  <div>
                    <h3 className="text-[15px] font-semibold text-foreground">Signature verification</h3>
                    <p className="mt-2 text-[14px] leading-relaxed text-muted-foreground">
                      Each delivery includes an{" "}
                      <code className="rounded bg-secondary px-1 py-0.5 font-mono text-[12px]">X-ENICE-Signature</code>{" "}
                  ...
                  <div>
                    ...
                    <div className="mt-3 rounded-lg border border-border">
                      {[
                        ...
                        <div key={event} className="flex flex-col gap-1 border-t border-border px-4 py-3 first:border-t-0 sm:flex-row sm:items-center sm:gap-6">
                          <code className="shrink-0 font-mono text-[12px] text-primary sm:w-44">{event}</code>
                          <span className="text-[13px] text-muted-foreground">{desc}</span>
                        </div>
                      ))}
                    </div>
