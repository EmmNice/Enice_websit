...
export const Route = createFileRoute("/status")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Live status for ENICE Group platforms, including PulsePay and PulseAssist.",
      },
    ],
  }),
...
const SERVICES = [
  {
    ...
    status: "Operational",
    desc: "Card issuance, wallet, and transaction rails.",
  },
  { name: "PulseAssist Engine", status: "Operational", desc: "Support routing and API layer." },
  {
    name: "ENICE Core APIs",
    status: "Operational",
    desc: "Ledger, KYC, and identity infrastructure.",
  },
  {
    name: "Developer Sandbox",
    status: "Operational",
    desc: "Beta sandbox for integration partners.",
  },
];
        ...
        <section className="border-b border-border bg-secondary/40 py-16 sm:py-20">
          <div className="mx-auto max-w-5xl px-5 sm:px-8">
            ...
            <p className="mt-4 max-w-2xl text-base leading-relaxed text-muted-foreground">
              Live status for every ENICE Group platform. If you're having an issue that isn't
              reflected here, please contact our team.
            </p>
