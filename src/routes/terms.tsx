      ...
      sections={[
        {
          ...
          body: (
            <p>
              ...
              an account. You agree to provide accurate information and maintain the security
              of your credentials. You are solely responsible for all activities that occur
              under your account.
            </p>
          ),
        },
        {
          ...
          body: (
            <p>
              ...
              designs, text, and trademarks on our services are the proprietary property of
              ENICE Group and are protected by applicable intellectual property laws. No
        ...
        },
        {
          ...
          body: (
            <ul className="list-disc space-y-2 pl-5">
              <li>
                Reverse engineer, decompile, or disrupt any full-stack infrastructure or
                networks managed by ENICE Group.
              </li>
              <li>
                Use our commerce platforms for fraudulent, unlawful, or unauthorized
                financial transactions.
              </li>
              <li>
                Circumvent any security protocols, access controls, or rate limits
                established on our web servers.
              </li>
            </ul>
          ),
        },
        {
          ...
          body: (
            <p>
              ...
              directors shall not be liable for any indirect, incidental, special, or
              consequential damages arising out of your use or inability to use our
              infrastructure platforms. Services are provided on an "AS IS" and "AS
              AVAILABLE" basis.
            </p>
          ),
        },
