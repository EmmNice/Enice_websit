              ...
              >
                ...
                <div className="flex flex-1 flex-col p-8 sm:p-10">
                  ...
                  <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                    ...
                    handles customer support routing, provides API-driven account management, and
                    hands calls to live agents in real time when needed.
                  </p>
                  <div className="mt-8 flex flex-wrap gap-3">
        ...
        <section className="border-t border-border bg-background py-20 sm:py-28">
          <div className="mx-auto max-w-7xl px-5 sm:px-8">
            <div className="mb-12">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                Platforms in development and planning, expanding what ENICE Group builds.
              </p>
            </div>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              >
                    ...
                    <div className="w-full max-w-xs space-y-1.5">
                      {[
                        ...
                        >
                          ...
                          <span className="font-mono text-[11px] text-white/70">${t.price}</span>
                          <span
                ...
                <div className="flex flex-1 flex-col p-8 sm:p-10">
                  ...
                  <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                    ENICE Group's digital asset platform, designed to make cryptocurrency and
                    digital finance simple, secure, and accessible within the ENICE ecosystem.
                  </p>
                  <div className="mt-8 flex flex-wrap gap-3">
                    <Link
                      to="/portfolio/pulsex"
