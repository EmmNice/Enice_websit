...
async function subscribeToUpdates(input) {
  ...
  await provider.upsertContact({
    ...
    attributes: {
      ...
      [UPDATES_PROPERTY_KEYS.subscribedAt]: alreadySubscribed ? existingSubscribedAt : (/* @__PURE__ */ new Date()).toISOString(),
...
var DEFAULT_SENDING_DOMAIN = "enicehq.com";
