...
function isRateLimited(ip) {
  ...
  if (!entry || now > entry.resetAt) {
    rateLimitMap.set(ip, { count: 1, resetAt: now + 6e5 });
    return false;
  }
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#09090b;padding:48px 24px;"><tr><td align="center">
    <table width="580" cellpadding="0" cellspacing="0" style="background:#111113;border:1px solid #27272a;border-radius:12px;overflow:hidden;max-width:580px;width:100%;">
      <tr><td style="background:#0f172a;padding:32px 48px;border-bottom:1px solid #1e293b;">
        <p style="margin:0;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:#64748b;font-weight:600;">ENICE GROUP \xB7 CLASSIFIED DISPATCH</p>
      ...
      <tr><td style="padding:24px 48px;border-top:1px solid #27272a;background:#0c0c0e;">
        <p style="margin:0;font-size:12px;color:#52525b;line-height:1.6;">Sent to <span style="color:#71717a;">${email}</span> \xB7 ENICE Group \xB7 Abuja &amp; Kaduna, Nigeria \xB7 <a href="https://enicehq.com" style="color:#3b82f6;text-decoration:none;">enicehq.com</a></p>
      </td></tr>
    </table>
  </td></tr></table>
</body></html>`;
}
function threeDayHtml(email) {
    ...
    <table width="580" cellpadding="0" cellspacing="0" style="background:#111113;border:1px solid #27272a;border-radius:12px;overflow:hidden;max-width:580px;width:100%;">
      ...
      <tr><td style="padding:40px 48px;">
        ...
        <div style="background:#1e3a5f;border:1px solid #2563eb;border-radius:8px;padding:20px 40px;text-align:center;">
          ...
          <p style="margin:6px 0 0;font-size:11px;letter-spacing:0.2em;text-transform:uppercase;color:#64748b;">Hours \xB7 Minutes \xB7 Seconds</p>
        </div>
      </td></tr>
      <tr><td style="padding:24px 48px;border-top:1px solid #27272a;background:#0c0c0e;">
        <p style="margin:0;font-size:12px;color:#52525b;line-height:1.6;">Sent to <span style="color:#71717a;">${email}</span> \xB7 ENICE Group \xB7 <a href="https://enicehq.com" style="color:#3b82f6;text-decoration:none;">enicehq.com</a></p>
      </td></tr>
    </table>
  </td></tr></table>
</body></html>`;
}
function oneDayHtml(email) {
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#09090b;padding:48px 24px;"><tr><td align="center">
    <table width="580" cellpadding="0" cellspacing="0" style="background:#111113;border:1px solid #27272a;border-radius:12px;overflow:hidden;max-width:580px;width:100%;">
      <tr><td style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);padding:48px 48px 40px;border-bottom:1px solid #1e293b;text-align:center;">
        <p style="margin:0 0 16px;font-size:11px;letter-spacing:0.28em;text-transform:uppercase;color:#3b82f6;font-weight:700;">ENICE GROUP \xB7 LAUNCH DAY</p>
        ...
        <p style="margin:16px 0 0;font-size:14px;color:#64748b;letter-spacing:0.08em;">JULY 18, 2026 \xB7 12:00 AM UTC</p>
      </td></tr>
      <tr><td style="padding:40px 48px;">
...
var watchlist_default = withErrorHandling(async function handler(req, res) {
  if (req.method !== "POST") {
